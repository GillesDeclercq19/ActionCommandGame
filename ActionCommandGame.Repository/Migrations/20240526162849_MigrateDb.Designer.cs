...
namespace ActionCommandGame.Repository.Migrations
{
    ...
    [Migration("20240526162849_MigrateDb")]
            ...
            modelBuilder.Entity("ActionCommandGame.Model.Player", b =>
                {
                    ...
                    b.Property<int?>("CurrentKiPlayerItemId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CurrentKiPlayerItemId");
            ...
            modelBuilder.Entity("ActionCommandGame.Model.Player", b =>
                {
                    ...
                    b.HasOne("ActionCommandGame.Model.PlayerItem", "CurrentKiPlayerItem")
                        .WithMany("KiPlayers")
                        .HasForeignKey("CurrentKiPlayerItemId");
                    ...
                    b.Navigation("CurrentKiPlayerItem");
